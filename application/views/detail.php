...
<body>
    ...
    <!-- ********** Hero Area Start ********** -->
    <div class="hero-area height-600 bg-img background-overlay" style="background-image: url('<?= base_url('assets/upload/konten/'. $konten->foto)?>');">
        <div class="container h-100">
            <div class="row h-100 align-items-center justify-content-center">
                <div class="col-12 col-md-8 col-lg-6">
                    <div class="single-blog-title text-center">
                        <!-- Catagory -->
                        <div class="post-cta"><a href="#"><?= $konten->nama_kategori;?></a></div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-lg-12">
                    <div class="single-blog-content mb-100">
                        <!-- Post Meta -->
                        <div class="post-meta">
                            <p><a href="#" class="post-author"><?= $konten->username;?></a> on <a href="#" class="post-date"><?= $konten->tanggal;?></a></p>
                        </div>
                        <!-- Post Content -->
                        <div class="post-content">
                            <h6><?= $konten->keterangan;?> <a href="<?= $konten->link;?>">Klik disini</a></h6>
                        </div>
                    </div>
                </div>
            </div>
